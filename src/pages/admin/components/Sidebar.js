...
import { MenuOutlined, CloseOutlined, HomeOutlined, LogoutOutlined,PlusOutlined,VideoCameraOutlined   } from '@ant-design/icons';
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto mt-14">
          <ul className="space-y-2 font-medium">
            <li>
              <Link
                to="/admin/home" // Replace with the correct path for All Movies Page
            ...
            <li>
              <Link
                to="/admin/movies/create" // Replace with the correct path for All Movies Page
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
